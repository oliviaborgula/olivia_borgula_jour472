...
#what percent of Baltimore census tracts are below the citywide median?
#count total tracts in Baltimore
baltcity_income %>%
   summarise(
    count_tracts = n()
  )
#divide # of tracts below median household income in 2020 by total tracts in 2020
view((97/200) * 100)
#48.5% of Baltimore City census tracts have a median household income below $49,875

#Tweet
#Nearly 50% of Baltimore City neighborhoods were below the citywide median household income of $49,875 in 2020. 
```
