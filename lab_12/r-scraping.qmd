...
```{r}
#first question: in the county with the highest median household income, which candidate recieved the most votes? Could also ask this question of the county with the lowest median household income.

#second question: In Baltimore County, what percent of the area's Hispanic population voted for Cox? 
#Could also ask a similar question of other races and for other candidates. I would answer this question by combining variables for race by county from the ACS with the table of votes by county and then filtering to Baltimore County.
```
