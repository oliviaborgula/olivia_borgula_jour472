...
Add data visualization as an image in R
```{r}
knitr::include_graphics("data-notebook/images/line_graph.png")
```
...
```{r}
column_colors <- c("Maryland" = "darkred",
                   "Baltimore City" = "darkblue",
                   "Baltimore County" = "darkgreen")
reshaped_pct %>%
  ggplot() +
  geom_col(aes(x = new_names, y = Percent, fill = new_names)) +
  theme(legend.position = "none") +
  labs(
    title = "Percent of Population Below Poverty Line in Baltimore City, Baltimore County and Maryland in 2022",
    subtitle = "Poverty line is determined by the U.S. Census Bureau",
    x = "Location",
    y = "Percent",
    caption = "Source: U.S. Census Bureau. Graph by Olivia Borgula, 3/12/24"
  )
...
Include data visualization as an image in R
```{r}
knitr::include_graphics("data-notebook/images/bar_graph2.png")
```
...
**SOURCES**
1. The Takeaway: https://www.wnycstudios.org/podcasts/takeaway/segments/race-class-and-baltimore-wire-and-citys-reality
2. Baltimore City report: https://www.baltimorecity.gov/sites/default/files/6_KeyTrends.pdf
3. History information: https://www.baltimorecity.gov/sites/default/files/5_History.pdf
