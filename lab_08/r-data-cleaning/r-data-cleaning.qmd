...
#In this example, summarization will not work properly because R considers "Maryland" "MD" and "md" as three different things, so filtering by "Maryland" and using summarization to get total population will produce an inaccurate result. To clean the data, we can overwrite the "MD" and "md" names using case_when to replace "MD" and "md" with "Maryland." 
