...
**FINAL MEMO**
Baltimore City residents in areas of high incarceration were less likely to vote in the 2020 general election. As the rate of incarceration per 100,000 people increased in the area, voter turnout percentage decreased. 
...
Median household income, on the other hand, was positively correlated with voter turnout. Wealthier areas had a significantly higher voter turnout percentage. Of the 16 areas with less than 50% of their voting-age population casting their ballots, only one had a median household income of more than $42,000.

As a whole, voter turnout in the city has significantly decreased since 2008, dropping from 68% to 58% in that time. 2020 saw the first rise in the decade-long period, with most election turnout numbers remaining below the Maryland average. In 2020, areas that had the most democratic-registered voters were also the areas with the highest concentration of Black residents and the lowest voter turnouts. 

This is especially significant ahead of the 2024 election. I could write multiple stories based on this data. I could write on about how incarceration plays a role in voter turnout. I would ask people about whether going through the criminal justice system discourages them from voting in the future and how low voter turnout impacts policy initiatives for incarcerated people. 

For a story about internet access and voting, I would examine how basic internet access can expand people’s access to voting and voter education, and how increasing internet access could shift peoples’ attitudes about the importance of casting their ballot on election day.
